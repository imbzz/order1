...
Page({
  data: {
    ...
    list: [
        {
            name: "我的预约",
            src: "../../projects/A00/skin/images/tabbar/my_cur.png",
            url: "../../projects/A00/my/index/my_index",
        },
       {
        name: '收藏',
        src: '../../image/collection.png',
        url: '/PPages/user_collection/user_collection'
      },
      {
        name: '足迹',
        src: '../../image/footstep.png',
        url: '/PPages/user_footstep/user_footstep'
      },
      // {
      //   name: '消息',
      //   src: '../../image/mes.png',
      //   url: '/PPages/user_message/user_message'
      // },
      {
        name: '动态',
        src: '../../image/myshare.png',
        url: '/PPages/user_share/user_share'
      }
    ],
  ...
  faceLogin() {
    ...
    if (userInfo) {
      ...
      wx.navigateTo({
        url: '/PPages/faceLogin/faceLogin',
      })
    }
  },
  ...
  faceRegister() {
    ...
    if (!userInfo) {
      ...
      wx.navigateTo({
        url: '/PPages/faceRegister/faceRegister',
      })
    }
  },
  ...
  gotoAgreement() {
    wx.navigateTo({
      url: '/PPages/user_agreement/user_agreement',
    })
  },
